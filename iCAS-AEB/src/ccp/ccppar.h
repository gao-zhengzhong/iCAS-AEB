...
#define CCP_DISABLE_INTERRUPT PSW_IEN        =  0;
#define CCP_ENABLE_INTERRUPT  PSW_IEN        =  1 ;
...
#define CCP_DTO_ID        0x6F1         /* CAN identifier ECU -> Master */
#define CCP_CRO_ID        0x6F0         /* CAN identifier Master -> ECU */
